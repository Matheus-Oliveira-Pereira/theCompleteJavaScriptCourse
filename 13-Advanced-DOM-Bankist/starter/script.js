...
//   threshold: [0], //define o limite que faz com que o a função de callback seja ativada, ou seja nessa caso quando chegar na section 1, e atingir um limite de 0.1 ou 10% do viewport a função é ativada
// };
...
function selectingCreateAndDeletingElements() {
  ...
  //adiciona por ultimmo no elemento, so pode adicionar uma vez, para mais vezes faça uma copia
