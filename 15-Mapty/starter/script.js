...
class Workout {
  ...
  constructor(coords, distance, durantion) {
    ...
    this.durantion = durantion; // in min
  }
...
class Cycling extends Workout {
  type = 'cycling';
  constructor(coords, distance, durantion, elevation) {
    super(coords, distance, durantion);
...
class App {
  ...
  _newWorkout(e) {
    ...
    if (type === `running`) {
      ...
      if (
        !validInputs(distance, durantion, cadence) ||
    ...
    if (type === `cycling`) {
      ...
      //check if data is valid
      if (
        !validInputs(distance, durantion, elevation) ||
  ...
  _renderWorkout(workout) {
    ...
    <li class="workout workout--${workout.type}" data-id="${workout.id}">
      ...
      <div class="workout__details">
        ...
        <span class="workout__value">${workout.durantion}</span>
